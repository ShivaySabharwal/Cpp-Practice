...
void add_movie(Movies &amovie, string name, int rating, int count);
...
int main()
{
    ...
    add_movie(my_movies, "DOM", "UA", 9);
    add_movie(my_movies, "Die Hard", "UA", 10);
    add_movie(my_movies, "ROBOT", "UA", 8);
    add_movie(my_movies, "GOAL", "UA", 10);
    add_movie(my_movies, "CHAK DE INDIA", "UA", 10);

    increment_watched(my_movies, "DOM");
    return 0;
}